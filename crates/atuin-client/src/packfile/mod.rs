...
//! manifest record, we invoke [`sync::download_packed`] (or [`sync::download_packed_many`]
...
pub use sync::{DownloadError, UploadError, download_packed_many, upload_packed_many};
